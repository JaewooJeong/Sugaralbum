 ...
 * The source Renderscript file: /Users/leeminchul/Documents/workspace_uplus_git/project/multimediaframework/ImageAnalysisEngine/ImageFrameworkLibrary/renderscript/toon.rs
 */
 ...
 * @hide
 */
public class ScriptC_toon extends ScriptC {
    private static final String __rs_resource_name = "toon";
    // Constructor
    public  ScriptC_toon(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_toon(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportVarIdx_quantizationLevels = 7;
