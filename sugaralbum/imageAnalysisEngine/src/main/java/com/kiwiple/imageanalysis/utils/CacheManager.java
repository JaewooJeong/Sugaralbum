...
public class CacheManager {
    ...
    /**
     * Return null when we cannot instantiate a BlobCache, e.g.: <br>
     * there is no SD card found.<br>
     * This can only be called from data thread.
     * 
     * @param context Context
     * @param filename Cache Name
     * @param maxEntries MaxEntries
     * @param maxBytes MaxBytes
     * @param version Version
     */
    public static BlobCache getBlobCache(Context context, String filename, int maxEntries,
