package com.sugarmount.sugarcamera.camera.Utils;
...
// Modified Chae,Soo-yang : ]
    ...
    public static final boolean HAS_TIME_LAPSE_RECORDING = false;
//            Build.VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB;
...
//            Build.VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN;
    ...
    public static final boolean HAS_ACTION_BAR = false;
...
// Modified Chae,Soo-yang : ]
    ...
    public static final boolean HAS_VIDEO_STABILIZATION =
            Build.VERSION.SDK_INT >= VERSION_CODES.ICE_CREAM_SANDWICH;
