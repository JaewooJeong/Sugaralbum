...
public class ImageChromaKeyBlendFilter extends ImageTwoInputFilter {
    ...
    public void init(Context context) {
        super.initWithFragmentShaderFromResource(context, "chromakey_blend_fragment");
    ...
    public void setSmoothing(float newValue) {
        setFloat(newValue, mSmoothingUniform, mProgram);
    }
    ...
    public ArtFilterInfo getFilterInfo() {
        if(mArtFilterInfo == null) {
            ...
            mArtFilterInfo = new ArtFilterInfo("ChromaKey blend", progressInfo);
        }
