...
public abstract class BaseGestureDetector {
     ...
     * This method delegates work to handler methods (handleStartProgressEvent,
    ...
    /**
     * Called when the current event occurred when NO gesture is in progress yet. The handling in
     * this implementation may set the gesture in progress (via mGestureInProgress) or out of
     * progress
     * 
     * @param actionCode
     * @param event
    ...
    public MotionEvent getPrevMotionEvent() {
        return mPrevEvent;
    }

    public MotionEvent getCurrMotionEvent() {
        return mCurrEvent;
    }
}
