 ...
 * The source Renderscript file: /Users/leeminchul/Documents/workspace_uplus_git/project/multimediaframework/ImageAnalysisEngine/ImageFrameworkLibrary/renderscript/stretch_outside.rs
 */
 ...
 * @hide
 */
public class ScriptC_stretch_outside extends ScriptC {
    private static final String __rs_resource_name = "stretch_outside";
    // Constructor
    public  ScriptC_stretch_outside(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_stretch_outside(RenderScript rs, Resources resources, int id) {
