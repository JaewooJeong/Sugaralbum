 ...
 */
public class ImageShiftToTopFilterL extends ImageFilter {
    ...
    public void init(Context context) {
        super.initWithFragmentShaderFromResource(context, "shift_top_fragment");
    ...
    public ArtFilterInfo getFilterInfo() {
        if(mArtFilterInfo == null) {
            ...
            mArtFilterInfo = new ArtFilterInfo("ShiftToTop", progressInfo);
        }
