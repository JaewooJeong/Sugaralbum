...
public final class ThemeVersion implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7347317991468491095L;
	...
	public static final String JSON_KEY_THEME_VERSION = "theme_version"; 
	...
	/**
	 * 수 버전. 기존 버전에서 preview json을 업데이트 해야 할 경우 증가. 
	 */
...
//	public final int revision;
	...
	// // // // // Constructor.
	// // // // //
	public ThemeVersion(int major, int minor, int patch) {
	...
	public ThemeVersion(JSONObject jsonObject) throws JSONException {
	 ...
	 */
	public boolean isAbove(ThemeVersion other) {
	 ...
	 */
	public boolean isBelow(ThemeVersion other) {
	...
	public boolean isSame(ThemeVersion other) {
