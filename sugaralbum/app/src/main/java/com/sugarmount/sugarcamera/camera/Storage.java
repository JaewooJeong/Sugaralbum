package com.sugarmount.sugarcamera.camera;
...
public class Storage {
    ...
    public static final long LOW_STORAGE_THRESHOLD = 104857600;	// 100 * 1024 * 1024 = 100MB
...
//    public static final long MOVIE_DIARY_STORAGE_THRESHOLD = 1048576000; // 1000 * 1024 * 1024 = 1000MB
    ...
    public static Uri addImage(ContentResolver resolver, String title,
        ...
        try {
        	...
        	Logger.e(TAG, "Failed to write MediaStore" + th);
        }
        return uri;
    }
    ...
    public static Uri newImage(ContentResolver resolver, String title,
        ...
        try {
            ...
            // insert it into MediaProvider. The only problem is that the user
            // cannot click the thumbnail to review the picture.
        	Logger.e(TAG, "Failed to new image" + th);
        }
        return uri;
    }
    ...
    public static boolean updateImage(ContentResolver resolver, Uri uri,
        ...
        try {
        	...
        	Logger.e(TAG, "Failed to write image", e);
            return false;
        } finally {
            try {
                out.close();
        ...
        try {
        	...
        	Logger.e(TAG, "Failed to update image" + th);
            return false;
        }
    ...
    public static void deleteImage(ContentResolver resolver, Uri uri) {
        try {
        	...
        	Logger.e(TAG, "Failed to delete image: " + uri);
        }
    }
    ...
    public static long getAvailableSpace() {
        ...
        Logger.d(TAG, "External storage state=" + state);
    ...
    public static void ensureOSXCompatible() {
        ...
        if (!(nnnAAAAA.exists() || nnnAAAAA.mkdirs())) {
        	Logger.e(TAG, "Failed to create " + nnnAAAAA.getPath());
        }
    }
}
