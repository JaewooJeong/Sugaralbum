 ...
 * The source Renderscript file: /Users/leeminchul/Documents/workspace_uplus_git/project/multimediaframework/ImageAnalysisEngine/ImageFrameworkLibrary/renderscript/rgb_erosion_radius_three.rs
 */
 ...
 * @hide
 */
public class ScriptC_rgb_erosion_radius_three extends ScriptC {
    private static final String __rs_resource_name = "rgb_erosion_radius_three";
    // Constructor
    public  ScriptC_rgb_erosion_radius_three(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_rgb_erosion_radius_three(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportForEachIdx_erosion_radius_three = 1;
    public Script.KernelID getKernelID_erosion_radius_three() {
        return createKernelID(mExportForEachIdx_erosion_radius_three, 1, null, null);
    }

    public void forEach_erosion_radius_three(Allocation ain) {
        forEach_erosion_radius_three(ain, null);
    }

    public void forEach_erosion_radius_three(Allocation ain, Script.LaunchOptions sc) {
        // check ain
        if (!ain.getType().getElement().isCompatible(__U8_4)) {
            throw new RSRuntimeException("Type mismatch with U8_4!");
        }
        forEach(mExportForEachIdx_erosion_radius_three, ain, null, null, sc);
    }
