...
public class ImageDilationFilter extends ImageTwoPassTextureSamplingFilter {
    ...
    public void initWithRadius(Context context, int dilationRadius) {
        ...
        switch(dilationRadius) {
            ...
            case 1: {
                ...
                fragmentShaderForThisRadius = "dilation_radius_one_fragment";
            }
                break;
            case 2: {
                vertexShaderForThisRadius = "dilation_radius_two_vertex";
                fragmentShaderForThisRadius = "dilation_radius_two_fragment";
            }
                break;
            case 3: {
                vertexShaderForThisRadius = "dilation_radius_three_vertex";
                fragmentShaderForThisRadius = "dilation_radius_three_fragment";
            }
                break;
            case 4: {
                vertexShaderForThisRadius = "dilation_radius_four_vertex";
                fragmentShaderForThisRadius = "dilation_radius_four_fragment";
            }
                break;
            case 5: {
                vertexShaderForThisRadius = "dilation_radius_five_vertex";
                fragmentShaderForThisRadius = "dilation_radius_five_fragment";
            }
                break;
            default: {
                vertexShaderForThisRadius = "dilation_radius_four_vertex";
    ...
    public ArtFilterInfo getFilterInfo() {
        if(mArtFilterInfo == null) {
            ...
            mArtFilterInfo = new ArtFilterInfo("Dilation", progressInfo);
        }
