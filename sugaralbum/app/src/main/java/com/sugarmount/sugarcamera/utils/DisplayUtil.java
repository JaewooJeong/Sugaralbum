...
//		Logger.v("DisplayUtil", "density dip : " + metrics.densityDpi);
	...
	public static boolean isDensityMdpi() {
	    Resources resources = SystemHelpers.getApplicationContext().getResources();
	    DisplayMetrics metrics = resources.getDisplayMetrics();
	    return metrics.densityDpi == DisplayMetrics.DENSITY_MEDIUM ? true : false;		
	}
