...
import com.kiwiple.imageframework.ScriptC_dilation_radius_five;
import com.kiwiple.imageframework.ScriptC_dilation_radius_four;
import com.kiwiple.imageframework.ScriptC_dilation_radius_one;
import com.kiwiple.imageframework.ScriptC_dilation_radius_three;
import com.kiwiple.imageframework.ScriptC_dilation_radius_two;
import com.kiwiple.imageframework.filter.live.RsYuv;

public class Dilation {
    private ScriptC_dilation_radius_one mDilationRadiusOne;
    private ScriptC_dilation_radius_two mDilationRadiusTwo;
    private ScriptC_dilation_radius_three mDilationRadiusThree;
    private ScriptC_dilation_radius_four mDilationRadiusFour;
    private ScriptC_dilation_radius_five mDilationRadiusFive;
    ...
    public Dilation(RenderScript rs, int width, int height) {
        mRs = rs;
        this.width = width;
        this.height = height;
