...
-keep,allowobfuscation,allowshrinking interface com.kiwiple.multimedia.** {*;}
-keep,allowobfuscation,allowshrinking interface com.kiwiple.multimedia.canvas.** {*;}
-keep,allowobfuscation,allowshrinking class com.kiwiple.multimedia.** {*;}
-keep,allowobfuscation,allowshrinking class com.kiwiple.multimedia.canvas.** {*;}
