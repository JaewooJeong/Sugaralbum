 ...
 * The source Renderscript file: /Users/leeminchul/Documents/workspace_uplus_git/project/multimediaframework/ImageAnalysisEngine/ImageFrameworkLibrary/renderscript/threshold_edge_detection_lite.rs
 */
 ...
 * @hide
 */
public class ScriptC_threshold_edge_detection_lite extends ScriptC {
    private static final String __rs_resource_name = "threshold_edge_detection_lite";
    // Constructor
    public  ScriptC_threshold_edge_detection_lite(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_threshold_edge_detection_lite(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportForEachIdx_threshold_edge_detection = 1;
    public Script.KernelID getKernelID_threshold_edge_detection() {
        return createKernelID(mExportForEachIdx_threshold_edge_detection, 1, null, null);
    }

    public void forEach_threshold_edge_detection(Allocation ain) {
        forEach_threshold_edge_detection(ain, null);
    }

    public void forEach_threshold_edge_detection(Allocation ain, Script.LaunchOptions sc) {
        // check ain
        if (!ain.getType().getElement().isCompatible(__U8_4)) {
            throw new RSRuntimeException("Type mismatch with U8_4!");
        }
        forEach(mExportForEachIdx_threshold_edge_detection, ain, null, null, sc);
    }
