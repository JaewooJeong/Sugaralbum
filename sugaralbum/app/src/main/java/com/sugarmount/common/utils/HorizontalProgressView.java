...
public class HorizontalProgressView extends View {
     ...
     */
    private int mStartColor = ContextCompat.getColor(getContext(), R.color.gray500);
    /**
     * the color of end progress
     */
    private int mEndColor = ContextCompat.getColor(getContext(), R.color.gray500);
    /**
     ...
     */
    private int mProgressTextColor = ContextCompat.getColor(getContext(), R.color.gray500);
    /**
     * the color of progress track
     */
    private int mTrackColor = ContextCompat.getColor(getContext(), R.color.gray500);
    /**
     * the duration of progress moving
     */
    private int mProgressDuration = 200;
    /**
    ...
    private void obtainAttrs(Context context, AttributeSet attrs){
        ...
        mStartColor = typedArray.getColor(R.styleable.HorizontalProgressView_start_color, ContextCompat.getColor(getContext(), R.color.gray500));
        mEndColor = typedArray.getColor(R.styleable.HorizontalProgressView_end_color,ContextCompat.getColor(getContext(), R.color.gray500));
        trackEnabled = typedArray.getBoolean(R.styleable.HorizontalProgressView_isTracked, false);
        mProgressTextColor = typedArray.getColor(R.styleable.HorizontalProgressView_progressTextColor, ContextCompat.getColor(getContext(), R.color.gray500));
        ...
        mTrackColor = typedArray.getColor(R.styleable.HorizontalProgressView_trackColor, ContextCompat.getColor(getContext(), R.color.gray500));
        textVisibility = typedArray.getBoolean(R.styleable.HorizontalProgressView_progressTextVisibility, true);
        mProgressDuration = typedArray.getInt(R.styleable.HorizontalProgressView_progressDuration, mProgressDuration);
        ...
        log.d("progressDuration: "+ mProgressDuration);
    ...
    private void setObjectAnimatorType(int animatorType){
        log.d("AnimatorType>>>>>>"+animatorType );
        switch (animatorType){
...
//        mRect = new RectF(
//                getPaddingLeft() + mStartProgress*(getWidth() - getPaddingLeft() - getPaddingRight() + 60)/100,
//                mTrackWidth,
//                (getWidth() - getPaddingRight()  - 20)*((moveProgress )/100),
//                getHeight()/2 + getPaddingTop());
