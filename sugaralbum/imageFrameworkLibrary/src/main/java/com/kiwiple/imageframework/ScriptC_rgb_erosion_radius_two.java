 ...
 * The source Renderscript file: /Users/leeminchul/Documents/workspace_uplus_git/project/multimediaframework/ImageAnalysisEngine/ImageFrameworkLibrary/renderscript/rgb_erosion_radius_two.rs
 */
 ...
 * @hide
 */
public class ScriptC_rgb_erosion_radius_two extends ScriptC {
    private static final String __rs_resource_name = "rgb_erosion_radius_two";
    // Constructor
    public  ScriptC_rgb_erosion_radius_two(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_rgb_erosion_radius_two(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportForEachIdx_erosion_radius_two = 1;
    public Script.KernelID getKernelID_erosion_radius_two() {
        return createKernelID(mExportForEachIdx_erosion_radius_two, 1, null, null);
    }

    public void forEach_erosion_radius_two(Allocation ain) {
        forEach_erosion_radius_two(ain, null);
    }

    public void forEach_erosion_radius_two(Allocation ain, Script.LaunchOptions sc) {
        // check ain
        if (!ain.getType().getElement().isCompatible(__U8_4)) {
            throw new RSRuntimeException("Type mismatch with U8_4!");
        }
        forEach(mExportForEachIdx_erosion_radius_two, ain, null, null, sc);
    }
