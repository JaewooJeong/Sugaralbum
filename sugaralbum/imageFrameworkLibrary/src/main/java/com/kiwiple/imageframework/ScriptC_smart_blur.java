 ...
 * The source Renderscript file: /Users/leeminchul/Documents/workspace_uplus_git/project/multimediaframework/ImageAnalysisEngine/ImageFrameworkLibrary/renderscript/smart_blur.rs
 */
 ...
 * @hide
 */
public class ScriptC_smart_blur extends ScriptC {
    private static final String __rs_resource_name = "smart_blur";
    // Constructor
    public  ScriptC_smart_blur(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_smart_blur(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportVarIdx_threshold = 4;
    ...
    private final static int mExportVarIdx_texelWidthOffset = 5;
    ...
    private final static int mExportVarIdx_texelHeightOffset = 6;
    ...
    private final static int mExportVarIdx_blurSize = 7;
