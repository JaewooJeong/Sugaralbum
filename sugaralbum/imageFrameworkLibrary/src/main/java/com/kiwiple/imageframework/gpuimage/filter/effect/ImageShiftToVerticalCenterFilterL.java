...
/**
 * [U+Camera>겔러리>편집>성형]의 갸름하게 기능을 위해 추가. 자동on기능에서 사용
 */
public class ImageShiftToVerticalCenterFilterL extends ImageFilter {
    ...
    public void init(Context context) {
        super.initWithFragmentShaderFromResource(context, "shift_vertical_center_fragment");
    ...
    public void setScale(float newValue) {
        setFloat(newValue * 0.2f, mScaleUniform, mProgram);
    }
    ...
    public ArtFilterInfo getFilterInfo() {
        if(mArtFilterInfo == null) {
            ...
            mArtFilterInfo = new ArtFilterInfo("ShiftToVirticalCenter", progressInfo);
        }
