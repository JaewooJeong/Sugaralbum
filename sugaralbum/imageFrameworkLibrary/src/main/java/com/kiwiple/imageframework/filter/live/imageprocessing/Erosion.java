...
import com.kiwiple.imageframework.ScriptC_erosion_radius_five;
import com.kiwiple.imageframework.ScriptC_erosion_radius_four;
import com.kiwiple.imageframework.ScriptC_erosion_radius_one;
import com.kiwiple.imageframework.ScriptC_erosion_radius_three;
import com.kiwiple.imageframework.ScriptC_erosion_radius_two;
import com.kiwiple.imageframework.filter.live.RsYuv;

public class Erosion {
    private ScriptC_erosion_radius_one mErosionRadiusOne;
    private ScriptC_erosion_radius_two mErosionRadiusTwo;
    private ScriptC_erosion_radius_three mErosionRadiusThree;
    private ScriptC_erosion_radius_four mErosionRadiusFour;
    private ScriptC_erosion_radius_five mErosionRadiusFive;
    ...
    public Erosion(RenderScript rs, int width, int height) {
        mRs = rs;
        this.width = width;
        this.height = height;
