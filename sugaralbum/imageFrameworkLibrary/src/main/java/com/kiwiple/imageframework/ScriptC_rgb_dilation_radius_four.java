 ...
 * The source Renderscript file: /Users/leeminchul/Documents/workspace_uplus_git/project/multimediaframework/ImageAnalysisEngine/ImageFrameworkLibrary/renderscript/rgb_dilation_radius_four.rs
 */
 ...
 * @hide
 */
public class ScriptC_rgb_dilation_radius_four extends ScriptC {
    private static final String __rs_resource_name = "rgb_dilation_radius_four";
    // Constructor
    public  ScriptC_rgb_dilation_radius_four(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_rgb_dilation_radius_four(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportForEachIdx_dilation_radius_four = 1;
    public Script.KernelID getKernelID_dilation_radius_four() {
        return createKernelID(mExportForEachIdx_dilation_radius_four, 1, null, null);
    }

    public void forEach_dilation_radius_four(Allocation ain) {
        forEach_dilation_radius_four(ain, null);
    }

    public void forEach_dilation_radius_four(Allocation ain, Script.LaunchOptions sc) {
        // check ain
        if (!ain.getType().getElement().isCompatible(__U8_4)) {
            throw new RSRuntimeException("Type mismatch with U8_4!");
        }
        forEach(mExportForEachIdx_dilation_radius_four, ain, null, null, sc);
    }
