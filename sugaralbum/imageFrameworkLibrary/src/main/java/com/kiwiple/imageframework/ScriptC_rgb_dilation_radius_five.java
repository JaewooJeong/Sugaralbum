 ...
 * The source Renderscript file: /Users/leeminchul/Documents/workspace_uplus_git/project/multimediaframework/ImageAnalysisEngine/ImageFrameworkLibrary/renderscript/rgb_dilation_radius_five.rs
 */
 ...
 * @hide
 */
public class ScriptC_rgb_dilation_radius_five extends ScriptC {
    private static final String __rs_resource_name = "rgb_dilation_radius_five";
    // Constructor
    public  ScriptC_rgb_dilation_radius_five(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_rgb_dilation_radius_five(RenderScript rs, Resources resources, int id) {
