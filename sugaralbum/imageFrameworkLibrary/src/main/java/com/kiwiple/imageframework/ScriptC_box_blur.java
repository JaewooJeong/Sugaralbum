 ...
 * The source Renderscript file: /Users/leeminchul/Documents/workspace_uplus_git/project/multimediaframework/ImageAnalysisEngine/ImageFrameworkLibrary/renderscript/box_blur.rs
 */
 ...
 * @hide
 */
public class ScriptC_box_blur extends ScriptC {
    private static final String __rs_resource_name = "box_blur";
    // Constructor
    public  ScriptC_box_blur(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_box_blur(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportVarIdx_texelWidthOffset = 0;
    ...
    private final static int mExportVarIdx_texelHeightOffset = 1;
    ...
    private final static int mExportVarIdx_blurSize = 2;
    ...
    private final static int mExportVarIdx_inAllocation = 3;
    ...
    private final static int mExportVarIdx_sampler = 6;
