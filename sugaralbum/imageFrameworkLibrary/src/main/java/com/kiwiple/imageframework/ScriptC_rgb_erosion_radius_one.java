 ...
 * The source Renderscript file: /Users/leeminchul/Documents/workspace_uplus_git/project/multimediaframework/ImageAnalysisEngine/ImageFrameworkLibrary/renderscript/rgb_erosion_radius_one.rs
 */
 ...
 * @hide
 */
public class ScriptC_rgb_erosion_radius_one extends ScriptC {
    private static final String __rs_resource_name = "rgb_erosion_radius_one";
    // Constructor
    public  ScriptC_rgb_erosion_radius_one(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_rgb_erosion_radius_one(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportForEachIdx_erosion_radius_one = 1;
    public Script.KernelID getKernelID_erosion_radius_one() {
        return createKernelID(mExportForEachIdx_erosion_radius_one, 1, null, null);
    }

    public void forEach_erosion_radius_one(Allocation ain) {
        forEach_erosion_radius_one(ain, null);
    }

    public void forEach_erosion_radius_one(Allocation ain, Script.LaunchOptions sc) {
        // check ain
        if (!ain.getType().getElement().isCompatible(__U8_4)) {
            throw new RSRuntimeException("Type mismatch with U8_4!");
        }
        forEach(mExportForEachIdx_erosion_radius_one, ain, null, null, sc);
    }
