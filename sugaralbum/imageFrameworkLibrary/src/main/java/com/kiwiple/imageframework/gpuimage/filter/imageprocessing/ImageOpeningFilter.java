...
public class ImageOpeningFilter extends ImageFilterGroup {
    private ImageErosionFilter erosionFilter = new ImageErosionFilter();
    private ImageDilationFilter dilationFilter = new ImageDilationFilter();
    ...
    public ArtFilterInfo getFilterInfo() {
        if(mArtFilterInfo == null) {
            ...
            mArtFilterInfo = new ArtFilterInfo("A/F7", progressInfo);
        }
