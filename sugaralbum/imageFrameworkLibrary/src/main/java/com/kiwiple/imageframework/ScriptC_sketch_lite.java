 ...
 * The source Renderscript file: /Users/leeminchul/Documents/workspace_uplus_git/project/multimediaframework/ImageAnalysisEngine/ImageFrameworkLibrary/renderscript/sketch_lite.rs
 */
 ...
 * @hide
 */
public class ScriptC_sketch_lite extends ScriptC {
    private static final String __rs_resource_name = "sketch_lite";
    // Constructor
    public  ScriptC_sketch_lite(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_sketch_lite(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportForEachIdx_sketch = 1;
    public Script.KernelID getKernelID_sketch() {
        return createKernelID(mExportForEachIdx_sketch, 1, null, null);
    }

    public void forEach_sketch(Allocation ain) {
        forEach_sketch(ain, null);
    }

    public void forEach_sketch(Allocation ain, Script.LaunchOptions sc) {
        // check ain
        if (!ain.getType().getElement().isCompatible(__U8_4)) {
            throw new RSRuntimeException("Type mismatch with U8_4!");
        }
        forEach(mExportForEachIdx_sketch, ain, null, null, sc);
    }
