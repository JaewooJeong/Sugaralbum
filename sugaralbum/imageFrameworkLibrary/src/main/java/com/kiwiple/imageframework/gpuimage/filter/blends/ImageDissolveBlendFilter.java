...
public class ImageDissolveBlendFilter extends ImageTwoInputFilter {
    ...
    public void init(Context context) {
        super.initWithFragmentShaderFromResource(context, "dissolve_blend_fragment");
    ...
    public ArtFilterInfo getFilterInfo() {
        if(mArtFilterInfo == null) {
            ...
            mArtFilterInfo = new ArtFilterInfo("Dissolve blend", progressInfo);
        }
